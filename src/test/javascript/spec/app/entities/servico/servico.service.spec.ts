...
import { IServico, Servico } from 'app/shared/model/servico.model';
...
describe('Service Tests', () => {
    describe('Servico Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ServicoService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Servico(0, 'AAAAAAA', 'AAAAAAA', 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Servico', async () => {
                const returnedFromService = Object.assign(
                    {
                        nome: 'BBBBBB',
                        descricao: 'BBBBBB',
