...
export class PagamentoService {
    private resourceUrl = SERVER_API_URL + 'api/pagamentos';
    ...
    private convertDateFromClient(pagamento: IPagamento): IPagamento {
        const copy: IPagamento = Object.assign({}, pagamento, {
            dataPagamento:
                pagamento.dataPagamento != null && pagamento.dataPagamento.isValid() ? pagamento.dataPagamento.format(DATE_FORMAT) : null
        });
        return copy;
    }
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((pagamento: IPagamento) => {
            pagamento.dataPagamento = pagamento.dataPagamento != null ? moment(pagamento.dataPagamento) : null;
        });
        return res;
    }
}
